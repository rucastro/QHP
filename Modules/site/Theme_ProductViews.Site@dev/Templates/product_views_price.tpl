		...
		{{#if showHighlightedMessage}}
			<div class="product-views-price-login-to-see-prices-highlighted">
				<p class="product-views-price-message">
					Please <a data-touchpoint="login" data-hashtag="login-register" data-parameters="origin_hash={{originHash}}&origin=home" href="{{urlLogin}}">log in</a> to see price or purchase this item
				</p>
			</div>
		{{else}}
			<div class="product-views-price-login-to-see-prices">
				<p class="product-views-price-message">
					<a data-touchpoint="login" data-hashtag="login-register" data-parameters="origin_hash={{originHash}}&origin=home" href="{{urlLogin}}">Log in</a> to see price
				</p>
			</div>
		{{/if}}
	{{/if}}
