...
<div class="search-bar">
	<div data-view="SiteSearch" data-type="SiteSearch" class="container"></div>
</div>

<div id="bottom-heading-text" class="bottom-heading-text" data-cms-area="bottom_heading_text" data-cms-area-filters="global"></div>