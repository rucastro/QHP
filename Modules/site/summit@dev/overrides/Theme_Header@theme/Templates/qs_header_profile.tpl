...
{{#if showExtendedMenu}}
	<a class="header-profile-welcome-link desktop-link" href="#" data-toggle="dropdown">
	...
	<a class="header-profile-welcome-link mobile-link" data-touchpoint="customercenter" data-hashtag="#overview" href="#" name="accountoverview">
		<i class="header-profile-welcome-user-icon"></i>
		{{translate 'Welcome <strong class="header-profile-welcome-link-name">$(0)</strong>' displayName}}
		<i class="header-profile-welcome-carret-icon"></i>
	</a>
