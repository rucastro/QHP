...
<div class="home-nopad">
	<!-- CAROUSEL
    Using the Configuration section under Layout > Carousel images
    -->
	{{#if showCarousel}}
						...
						<div class="home-slide-main-container">
							...
							<div class="home-slide-caption">
								...
								<div class="home-slide-caption-button-container">
									{{#if linktext}}<a{{objectToAtrributes item}} class="home-slide-caption-button">{{linktext}}<i class="home-slide-button-icon"></i></a>{{/if}}
								</div>
							</div>
						</div>
					</li>
...
<div class="home-nopad">
	...
	<!--
    INFOBLOCKS
    Using the Configuration section under Layout > Infoblocks
