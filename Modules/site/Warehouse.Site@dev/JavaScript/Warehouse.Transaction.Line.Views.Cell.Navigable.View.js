...
define('Warehouse.Transaction.Line.Views.Cell.Navigable.View'
,	[	'Transaction.Line.Views.Options.Selected.View'
	...
	,	'warehouse_transaction_line_views_cell_navigable.tpl'
		...
		getContext: function () {
			...
			return {
				...
				,	thumbnail: this.model.getThumbnail()
					// Checks wether an item can be distributed or ship on a specific warehouse
				,	shipOptions: line.get('shipOptions')

				,	shipOptionsText: line.get('shipOptionsText')

				,	shipOptionsAction: line.get('shipOptionsAction')

				,	warehouse: line.get('warehouseId')

				,	stock: (line.get('stockStatus') == 'instock') ? 'Available' : 'Back Ordered'
			};
		}
