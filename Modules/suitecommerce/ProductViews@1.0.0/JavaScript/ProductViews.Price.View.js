	...
	,	getContext: function ()
		{
			...
			var originHash = encodeURIComponent(this.options.origin === 'PDPQUICK' ? this.model.generateURL().replace('/', '') : Backbone.history.fragment).toString();

			//@class ProductViews.Price.View.Context
			return {
					//TODO REMOVE THIS FROM HERE, THIS CODE SHOULD NOT BE HERE!
					//TODO Use the Plugin Concept
